...
const UpgradePaymentPage = lazy(
    () => import("~/components/UpgradePaymentPage")
);
const UpgradePaymentSuccessPage = lazy(
    () => import("~/components/UpgradePaymentSuccessPage")
);
...
const ServiceComboManager = lazy(
    () => import("~/components/ServiceComboManager")
);
...
const CreateServiceCombo = lazy(
    () => import("~/components/CreateServiceCombo")
);
        ...
        <BrowserRouter>
            ...
            >
                <Routes>
                    ...
                    <Route
                        path="/upgrade/payment/:upgradeRequestId"
                        element={<UpgradePaymentPage />}
                    />
                    <Route
                        path="/upgrade/payment/success/:upgradeRequestId"
                        element={<UpgradePaymentSuccessPage />}
                    />
                    <Route
                    ...
                    {/* Quản lý dịch vụ */}
                    <Route
                        path="/service-combo-manager"
                        element={<ServiceComboManager />}
                    />
                    <Route
                    ...
                    <Route
                        path="/create-service-combo"
                        element={<CreateServiceCombo />}
                    />
                    <Route
                        path="/edit-service-combo"
                        element={<EditServiceCombo />}
                    />

            ...
            const ratingPromises = tours.map(async (tour) => {
                ...
                try {
                    ...
                    if (import.meta.env.DEV) {
                        console.warn(
                            `Không thể lấy rating cho service ${id}:`,
                            error
                        );
                    }
                    return { id, rating: 0 };
                        ...
                        const userPromises = Array.from(userIds).map(
                            async (userId) => {
                                try {
                                    ...
                                    console.warn(
                                        `Không thể lấy user data cho userId ${userId}:`,
                                        error
                                    );
    ...
    const mapServiceComboToService = useMemo(() => {
        return (serviceCombo: ServiceComboResponse): ServiceItem => {
            ...
            if (!imagePath || imagePath.trim() === "") {
                console.warn(
                    `  [LandingPage] Service ${id} (${name}) không có imagePath, dùng fallback: ${image}`
                );
            } else {
                console.log(
                    `[LandingPage] Service ${id} (${name}): imagePath="${imagePath}" → image="${image}"`
                );
            }
            ...
            const serviceRating =
                id !== null && ratings[id] !== undefined ? ratings[id] : 0;
            ...
            console.log(
                `   → [LandingPage] Mapped service object:`,
                mappedService
            );
    ...
    const displayServices = useMemo(() => {
        ...
        const activeServices = tours
            .filter((service) => {
                ...
                if (!isOpen) {
                    console.log(
                        `  [LandingPage] Bỏ qua service có status: ${status}`
                    );
                }
                return isOpen;
            })
        ...
        console.log(
            "[LandingPage] Services sau khi map và sắp xếp theo rating:",
            activeServices
        );
        console.log(
            "[LandingPage] Số lượng services sau khi map:",
            ...
            <main>
                        ...
                        <div className="hero-grid">
                            ...
                            >
                                ...
                                <div className="hero-badge" role="banner">
                                    ...
                                    />
                                    <span>
                                        Trải nghiệm thiên nhiên hoang sơ
                                    </span>
                                </div>
                                ...
                                <div className="hero-text">
                                    ...
                                    <p className="hero-description">
                                        Đặt dịch vụ theo nhóm thông minh, tiết
                                        kiệm chi phí và tạo những kỷ niệm đáng
                                        nhớ với công nghệ và dịch vụ hoàn hảo.
                                    </p>
                                </div>
                                ...
                                <Button size="lg" className="hero-cta" asChild>
                                    <Link
                                        to="/services"
                                        aria-label="Khám phá các dịch vụ du lịch"
                                    >
                                        Khám phá ngay
                                        <ArrowRightIcon
                                            className="btn-icon"
                            ...
                            {/* Right Column - Image */}
                            <div
                                className={`hero-image ${isVisible ? "fade-in-right" : ""}`}
                            >
                ...
                >
                    <div className="section-container">
                        <div
                            className={`section-header ${visibleSections.has("features") ? "fade-in-up" : ""}`}
                        >
                            <h2 id="features-title" className="section-title">
                                Tại sao chọn ESCE Du lịch?
                            </h2>
                            <p className="section-subtitle">
                                Chúng tôi mang đến trải nghiệm du lịch sinh thái
                                độc đáo với công nghệ đặt dịch vụ nhóm tiên tiến
                            </p>
                        </div>
                ...
                >
                    <div className="section-container">
                        <div
                            className={`services-header ${visibleSections.has("services") ? "fade-in-up" : ""}`}
                        >
                            <div className="services-header-text">
                                ...
                                <p className="section-subtitle services-subtitle">
                                    Khám phá những điểm đến tuyệt vời nhất Đà
                                    Nẵng
                                </p>
                            </div>
                        ...
                        {loading ? (
                            <div className="services-grid">
                                {[...Array(6)].map((_, index) => (
                                    <div
                                        key={index}
                                        className="lp-service-card-skeleton"
                                    >
                                        <Card className="lp-service-card-inner">
                                            <div
                                                className="lp-service-image-wrapper"
                                                style={{
                            ...
                            <div className="services-empty">
                                <p>
                                    Hiện tại không có dịch vụ nào. Vui lòng quay
                                    lại sau.
                                </p>
                            </div>
                        )}
                ...
                >
                    <div className="section-container">
                        <div
                            className={`section-header ${visibleSections.has("testimonials") ? "fade-in-up" : ""}`}
                        >
                            <h2
                            ...
                            <p className="section-subtitle">
                                Hơn 1,000+ khách hàng đã tin tưởng và có những
                                trải nghiệm tuyệt vời cùng ESCE Du lịch
                            </p>
                        </div>
                        ...
                        {loadingReviews ? (
                            <div className="reviews-grid">
                                {[...Array(3)].map((_, index) => (
                                    <div
                                        key={index}
                                        className="review-card-skeleton"
                                    >
                ...
                >
                    <div className="section-container">
                        <div
                            className={`cta-content ${visibleSections.has("cta") ? "fade-in-up" : ""}`}
                        >
                            <h2 id="cta-title" className="cta-title">
                                Sẵn sàng khám phá cùng chúng tôi?
                            </h2>
                            <p className="cta-subtitle">
                                Hãy để chúng tôi mang đến cho bạn những trải
                                nghiệm du lịch sinh thái tuyệt vời nhất.
                            </p>
        ...
        >
            <Card className="lp-service-card-inner">
                <div className="lp-service-image-wrapper">
                    ...
                    {service.availableSlots !== undefined &&
                        service.availableSlots > 0 && (
                            <Badge
                                variant="success"
                                className="lp-service-badge lp-service-badge-slots"
                            >
                ...
                <CardContent className="lp-service-content">
                    ...
                    {service.address && (
                        <p className="lp-service-address">{service.address}</p>
                    )}
                    <div className="lp-service-rating">
                        <div
                            className="stars"
                            aria-label={`Đánh giá ${service.rating || 0} sao`}
                        >
                            {(() => {
                                const rating =
                    ...
                    <div className="lp-service-price-wrapper">
                        <div>
                            <span className="lp-service-price">
                                {formatPrice(service.priceFrom)}
                            </span>
                            {service.originalPrice && (
                                <span className="lp-service-price-old">

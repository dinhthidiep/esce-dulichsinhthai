      ...
      <main className={`content ${sidebarActive ? 'shift' : ''}`} role="main">
        <div className="form-content">
          ...
          <form id="createServiceForm" onSubmit={handleSubmit} noValidate>
            ...
            {/* Image Upload Field */}
            <div className="field">
              <label htmlFor="image">Chọn ảnh mới (New Image) - Để trống nếu không muốn thay đổi</label>
              <input
                id="image"
                name="image"
                type="file"
              ...
              {currentImageUrl && !imagePreview && (
                <div style={{ marginTop: '10px' }}>
                  <p style={{ fontSize: '0.9em', color: '#666' }}>Ảnh hiện tại:</p>
                  <img
                    src={currentImageUrl}
                    alt="Ảnh hiện tại"
                    loading="lazy"
                    style={{ maxWidth: '300px', maxHeight: '300px', marginTop: '5px', borderRadius: '4px' }}
                  />
                </div>
              )}
            </div>

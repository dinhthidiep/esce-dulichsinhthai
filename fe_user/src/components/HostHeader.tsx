...
const HostHeader = React.memo(() => {
    ...
    useEffect(() => {
        const handleClickOutside = (event: MouseEvent) => {
            ...
            if (
                !target.closest(".host-header-user-menu-container") &&
    ...
    return (
        <header
            className={`host-header ${isScrolled ? "host-header-scrolled" : ""}`}
        >
            <div className="host-header-container">
                ...
                <Link to="/host-dashboard" className="host-header-logo-section">
                    <img
                        ...
                        alt="ESCE Logo"
                        className="host-header-logo"
                    />
                    <div className="host-header-logo-text">
                        <div className="host-header-logo-text-main">
                            Host Dashboard
                        </div>
                        <div className="host-header-logo-text-sub">
                            Quản lý dịch vụ
                        </div>
                    </div>
                </Link>
                ...
                <div className="host-header-actions">
                    ...
                    {/* Notification Bell */}
                    <div
                        className="host-header-notification-bell-container"
                    ...
                    >
                        ...
                        >
                            ...
                            {unreadCount > 0 && (
                                <span className="host-header-notification-badge">
                                    {unreadCount}
                                </span>
                            )}
                        </button>
                    ...
                    {/* User Menu */}
                    <div
                        className="host-header-user-menu-container"
                        style={{ position: "relative" }}
                    >
                        <button
                        ...
                        >
                            ...
                            {userInfo && (
                                <div className="host-header-user-info-inline">
                                    ...
                                    <span className="host-header-user-role-inline">
                                        Host
                                    </span>
                                </div>
                            )}

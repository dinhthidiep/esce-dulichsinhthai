...
namespace ESCE_SYSTEM.Migrations
{
    ...
    [Migration("20251209113545_AddBonusServiceFeature")]
    partial class AddBonusServiceFeature
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ESCE_SYSTEM.Models.BonusService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("BONUS_SERVICES", (string)null);
                });
            ...
            modelBuilder.Entity("ESCE_SYSTEM.Models.BookingBonusService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("BonusServiceId")
                        .HasColumnType("int")
                        .HasColumnName("BONUS_SERVICE_ID");
                    ...
                    b.HasIndex("BonusServiceId");

                    b.HasIndex("BookingId");

                    b.ToTable("BOOKING_BONUS_SERVICES", (string)null);
                });
            ...
            modelBuilder.Entity("ESCE_SYSTEM.Models.CouponBonusService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("COUPON_BONUS_SERVICES", (string)null);
                });
            ...
            modelBuilder.Entity("ESCE_SYSTEM.Models.BookingBonusService", b =>
                {
                    b.HasOne("ESCE_SYSTEM.Models.BonusService", "BonusService")
                        .WithMany("BookingBonusServices")
                        .HasForeignKey("BonusServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_BOOKING_BONUS_SERVICES_BONUS_SERVICE");
                    ...
                    b.HasOne("ESCE_SYSTEM.Models.Booking", "Booking")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_BOOKING_BONUS_SERVICES_BOOKING");

                    b.Navigation("BonusService");
            ...
            modelBuilder.Entity("ESCE_SYSTEM.Models.CouponBonusService", b =>
                {
                    b.HasOne("ESCE_SYSTEM.Models.BonusService", "BonusService")
                        .WithMany("CouponBonusServices")
                        .HasForeignKey("BonusServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_COUPON_BONUS_SERVICES_BONUS_SERVICE");
                    ...
                    b.HasOne("ESCE_SYSTEM.Models.Coupon", "Coupon")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_COUPON_BONUS_SERVICES_COUPON");
            ...
            modelBuilder.Entity("ESCE_SYSTEM.Models.Review", b =>
                {
                    ...
                    b.HasOne("ESCE_SYSTEM.Models.ServiceCombo", null)
                        .WithMany("Reviews")
                        .HasForeignKey("ServiceComboId");
            ...
            modelBuilder.Entity("ESCE_SYSTEM.Models.BonusService", b =>
                {
                    b.Navigation("BookingBonusServices");

                    b.Navigation("CouponBonusServices");
                });
